...
<html>
    ...
    <%        if (request.getParameter("btn_update") != null) {
            ...
            String upQry = "update tbl_user set "
                    ...
                    + "user_photo='" + request.getParameter("txt_pic") + "',"
        ...
        <div id="tab" align="center">
            ...
            <form method="post">
                <table border="1">
                    ...
                    %>
                    <tr>
                        <td colspan="2" align="center"><img id="img_pic" src="<%=rs.getString("user_photo")%>" style="border-radius: 50%" width="120" height="120">

...
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
  <meta charset="UTF-8">
  <title>Blue Payment Gateway</title>
  ...
  <div class="payment">
    ...
    <div class="form">
      <div class="card space icon-relative">
        ...
        <input type="text" class="input" placeholder="Card Holder" pattern="[a-zA-Z. ]">
      ...
      {
         String up = "update tbl_payment set payment_status=1 where payment_id='"+request.getParameter("pay")+"'"; 

            ...
            <div class="chat-inner">
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="../../Assets/admin/img/icon/College.png" alt="">
                            </div>
                            <div class="username">
                                <span>Group</span>
                            </div>
                ...
                <div id="chat-sidebar" class="users-sidebar">   
                    ...
                    <div class="conversations-list has-slimscroll-xs">
                        ...
                        <div class="user-item">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 32px; height:32px " src="<%=session.getAttribute("uphoto")%>" alt="">
                            </div>
                        </div>
                        <%
                        ...
                        <div class="user-item" 
                            ...
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 32px; height:32px " src="<%=rs.getString("user_photo")%>" alt="">
                            </div>
                        </div>
                        <%
                            }

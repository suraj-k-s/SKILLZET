        ...
        <div class="sidebar-v1 is-fold">
            <div class="top-section">
                ...
                <div class="user-block">
                    <img class="avatar" src="<%=session.getAttribute("uphoto")%>" alt="">
                    <div class="meta">
                        <span style="margin-left: 7px"><%=session.getAttribute("uname")%></span>
                    ...
                    <div class="controls">
                                    ...
                                    <div class="nav-drop-body is-friend-requests">
                                        ...
                                        <div class="media">
                                            <div class="media-content">
                                                <a href="Group/Chat.jsp">Group</a>
                                            </div>
                                            <div class="media-right is-centered">
                                                <div class="added-icon">
                                                    <a href="Group/Chat.jsp" > <i data-feather="message-square"></i></a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                            <div class="user-image">
                                <img src="<%=session.getAttribute("uphoto")%>" alt="">
                                <span class="indicator"></span>
                            </div>
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <div class="story-block">
                                        <div class="img-wrapper">
                                            <img src="<%=rs1.getString("user_photo")%>" data-user-popover="1" alt="">
                                        </div>
                                        <div class="story-meta">
                                            <span><%=rs1.getString("user_name")%></span>
                                        </div>
                                    </div>
        ...
        <script>
                                    ...
                                    function insPost()
                                    {
                                        ...
                                        if (div.trim() === "")
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxPost.jsp',
                                    ...
                                    function loadPage()
                                    {
                                        $("#post-load").load('../Assets/AjaxPages/AjaxPostLoad.jsp');
                                    }
                                    ...
                                    function onLike(img)
                                    {
                                        ...
                                        if (name === 'heart-b.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxLike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                        ...
                                        else if (name === 'heart-r.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxDislike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                    ...
                                    function comment(id)
                                    {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '../Assets/AjaxPages/AjaxComment.jsp',
                                            data: {id: id,
                                                content: content},
                                            success: function(result) {
                                                loadPage();

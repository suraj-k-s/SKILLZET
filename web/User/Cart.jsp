            ...
            <div class="shopping-cart" style="margin-top: 50px">
                ...
                <div class="product">
                    <div class="product-image">
                        <img
                            src="../Assets/Files/<%=rsProduct.getString("product_photo")%>"
                            />
                    </div>
                    <div class="product-details">
                        <div class="product-title"><%=rsProduct.getString("product_name")%></div>
                        <p class="product-description">
                            <%=rsProduct.getString("product_details")%>
                        </p>
                    </div>
                    <div class="product-price"><%=rsProduct.getString("product_rate")%></div>
                    <div class="product-quantity">
                        <input alt="<%=rs.getString("cart_id")%>" type="number" value="<%=rs.getString("cart_qty")%>" min="1" />
                    </div>

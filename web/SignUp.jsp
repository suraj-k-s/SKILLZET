...
<html lang="en">
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            String insQry = "insert into tbl_user(user_name,user_contact,user_email,user_address,user_photo,user_password,place_id)"
            ...
            <div class="outer-panel">
                <div class="outer-panel-inner">
                    <div class="process-title">
                        <h2 id="step-title-1" class="step-title is-active" style="margin-top: 25px">Welcome to SKILLZET.</h2>
                            ...
                            <div class="columns mt-4">
                                ...
                                <div class="column is-4">
                                    <div class="account-type">
                                        ...
                                        <p>Create a account to be able to do some awesome things.</p>
                        ...
                        <div id="signup-panel-2" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    <label>Name</label>
                                    <div class="control">
                                        <input type="text" required="" class="input" id="txt_name" name="txt_name" placeholder="Enter User name">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Contact</label>
                                    <div class="control">
                                        <input  required="" type="tel" pattern="^\d{10}$" id="txt_number" name="txt_number" class="input" placeholder="Enter User contact">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <label>Address</label>
                                    <div class="control">
                                        <textarea class="input" required="" id="txt_address" name="txt_address" placeholder="Enter User address" style="border: none;background: transparent"></textarea>
                                    </div>
                                </div>
                                <div class="field">
                        ...
                        <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                <div class="field">
                                    <label>Email</label>
                                    <div class="control">
                                        <input required="" type="email"  id="txt_email" name="txt_email" class="input" placeholder="Enter User email address">
                                    </div>
                                </div>
                                <div class="field">
                        ...
                        <div id="signup-panel-5" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="success-text">
                                    ...
                                    <p> Wait For 24 hours to Confirm Your Account.</p>

...
<%
    String selQry = "select * from tbl_post order by post_id desc";
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <div class="likers-group">
                    ...
                    <img src="<%
                        out.println(cvv.getString("user_photo"));
                         %>" >
                ...
                <div class="likers-text">
                    <p>
                        ...
                        <a href="javascript:void(0)"><%=cvv1.getString("user_name")%></a>
                ...
                <div class="social-count">
                    <div class="likes-count">
                        <%                            String zx1 = "select * from tbl_like where post_id='" + rs.getString("post_id") + "' and user_id='" + session.getAttribute("uid") + "'";
            ...
            <div class="comments-body has-slimscroll">
                ...
                <div class="media is-comment">
                    ...
                    <div class="media-left">
                        <div class="image">
                            <img src="<%=ccc.getString("user_photo")%>" >
                        </div>
                    </div>
                    <!-- Content -->
                    <div class="media-content">
                        <a href="javascript:void(0)"><%=ccc.getString("user_name")%></a>

    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_game
                {
                    ...
                    photo = "GamePhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
        ...
        String InsQry = "INSERT INTO `tbl_game`(game_name,game_details,game_photo)"
                + "values('" + value[0] + "','" + value[1] + "','" + photo + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Admin/Game.jsp'

    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            if (f_item.isFormField()) {
                ...
                value[k] = f_item.getString();//shop typing value
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_event
                {
                    ...
                    photo = "EventPhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
        ...
        String InsQry = "INSERT INTO `tbl_event`(event_name,event_details,event_fee,event_date,event_time,event_photo)"
                + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','" + photo + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Admin/Event.jsp'
